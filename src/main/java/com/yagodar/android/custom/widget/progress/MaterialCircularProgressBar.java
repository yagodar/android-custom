...
public class MaterialCircularProgressBar extends View {
    ...
    private int barColor = Color.LTGRAY;
    private int rimColor = Color.TRANSPARENT;
    ...
    /**
     * The constructor for the MaterialCircularProgressBar
     */
    public MaterialCircularProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.MaterialCircularProgressBar));
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.MaterialCircularProgressBar_circle_radius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MaterialCircularProgressBar_fill_radius, false);

        barWidth = (int) a.getDimension(R.styleable.MaterialCircularProgressBar_bar_width, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MaterialCircularProgressBar_rim_width, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.MaterialCircularProgressBar_spin_speed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.MaterialCircularProgressBar_bar_spin_cycle_time, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MaterialCircularProgressBar_bar_color, barColor);

        rimColor = a.getColor(R.styleable.MaterialCircularProgressBar_rim_color, rimColor);

        linearProgress = a.getBoolean(R.styleable.MaterialCircularProgressBar_linear_progress, false);

        if (a.getBoolean(R.styleable.MaterialCircularProgressBar_indeterminate, false)) {
            spin();
        }
